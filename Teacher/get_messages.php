...
if (!isset($_SESSION['teacher_id']) || !isset($_GET['conversation_id'])) {
...
try {
    ...
    // Verify conversation
    $verify_query = "
        SELECT c.*, s.firstname, s.lastname, s.student_id,
    ...
    $stmt->bind_param("ii", $conversation_id, $teacher_id);
    $stmt->execute();
    ...
    $messages_query = "
        SELECT 
            m.*,
            CASE 
                WHEN m.sender_type = 'teacher' THEN t.firstname
                ELSE s.firstname
            END as sender_name,
            CASE 
                WHEN m.sender_type = 'teacher' THEN '../images/teacher.png'
                ELSE CONCAT('../images/student', s.student_id, '.png')
    ...
    <div class="messages-header">
        <div class="recipient-info">
            <img src="<?php echo htmlspecialchars($conversation['student_picture']); ?>" 
        ...
        <div class="message-actions">
            <button class="btn btn-link" title="Search"><i class="fas fa-search"></i></button>
            <button class="btn btn-link" title="More options"><i class="fas fa-ellipsis-v"></i></button>
        </div>
    </div>

    <div class="messages-list" id="messagesList">
        <?php foreach ($messages as $message): ?>
            <div class="message <?php echo $message['sender_type'] === 'teacher' ? 'sent' : 'received'; ?>">
                ...
                <div class="message-content">
                    ...
                    <div class="message-info">
                        ...
                        <?php if ($message['read_status'] && $message['sender_type'] === 'teacher'): ?>
    ...
    <div class="message-input">
        <form id="replyForm" class="reply-form">
            ...
            <input type="hidden" name="student_id" value="<?php echo $conversation['student_id']; ?>">
    ...
    $(document).ready(function() {
        ...
        $('#replyForm').on('submit', function(e) {
            ...
            formData.append('student_id', form.find('[name="student_id"]').val());
