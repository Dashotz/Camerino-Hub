...
$query = "SELECT s.*, c.cys, c.department, c.major 
          FROM teacher t
...
$teacherSubject = $result->fetch_assoc();

// Add this debug line temporarily
error_log("User Data: " . print_r($teacherSubject, true));
...
<body>
        ...
        <div class="table-container">
            <div class="table-header mb-4">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h2 class="mb-0"><i class="fas fa-book mr-2"></i>My Subject</h2>
                    </div>
                    <div class="col-md-6 text-md-right">
                        <div class="search-box">
                            <input type="text" id="searchSubject" class="form-control" placeholder="Search...">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php if ($teacherSubject && !empty($teacherSubject)): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($teacherSubject['subject_code'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($teacherSubject['subject_title'] ?? ''); ?></td>
                            <td><span class="badge badge-primary"><?php echo htmlspecialchars($teacherSubject['category'] ?? ''); ?></span></td>
                            <td><?php echo htmlspecialchars($teacherSubject['cys'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($teacherSubject['department'] ?? ''); ?></td>
                            <td><?php echo htmlspecialchars($teacherSubject['major'] ?? ''); ?></td>
                            <td><span class="badge badge-success">Assigned</span></td>
                        </tr>
                        <?php else: ?>
                        <tr>
                            <td colspan="7" class="text-center">No subject assigned yet. Please contact the administrator.</td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    <script>
    // Keep only the search functionality if needed
    ...
    // Success/error messages for other actions
