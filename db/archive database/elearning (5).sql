...
CREATE TABLE `activities` (
  ...
  `fullscreen_required` tinyint(1) DEFAULT 1,
  `prevent_tab_switch` tinyint(1) DEFAULT 1,
...
INSERT INTO `activities` (`activity_id`, `teacher_id`, `class_id`, `title`, `description`, `type`, `file_path`, `quiz_link`, `due_date`, `created_at`, `updated_at`, `points`, `fullscreen_required`, `prevent_tab_switch`, `prevent_copy_paste`, `time_limit`) VALUES
(1, 2, 6, 'TITE', 'Test', 'activity', 'uploads/activities/activity_672b6fb958a75.docx', NULL, '2024-11-06', '2024-11-06 13:31:37', '2024-11-06 14:49:10', 100, 1, 1, 1, 60),
(2, 2, 6, 'Quiz #1', 'Quiz', 'quiz', NULL, 'https://docs.google.com/forms/d/e/1FAIpQLSeeUp9_bBSrMxRJ4utLvnjjuCQu56OHOgeDZxiv3Gkdd8DEew/viewform?usp=sf_link', '2024-11-08', '2024-11-06 14:27:20', '2024-11-06 14:49:13', 100, 1, 1, 1, 60);
...
(7, 3, 1, '2024-03-24', 'present'),
(8, 4, 1, '2024-03-24', 'present'),
(9, 5, 1, '2024-03-24', 'present'),
(10, 3, 1, '2024-03-25', 'present'),
(11, 4, 1, '2024-03-25', 'late'),
(12, 5, 1, '2024-03-25', 'absent'),
(13, 1, 1, '2024-03-24', 'present'),
(14, 1, 1, '2024-03-25', 'present'),
(15, 1, 1, '2024-03-26', 'absent'),
(16, 2, 1, '2024-03-24', 'present'),
(17, 2, 1, '2024-03-25', 'present'),
(18, 2, 1, '2024-03-26', 'present'),
(19, 3, 1, '2024-03-24', 'present'),
(20, 3, 1, '2024-03-25', 'present'),
(21, 3, 1, '2024-03-26', 'absent'),
(22, 4, 1, '2024-03-24', 'present'),
(23, 4, 1, '2024-03-25', 'present'),
(24, 4, 1, '2024-03-26', 'present'),
(25, 3, 1, '2024-03-24', 'present'),
(26, 3, 1, '2024-03-25', 'present'),
(27, 3, 1, '2024-03-26', 'absent'),
(28, 4, 1, '2024-03-24', 'present'),
(29, 4, 1, '2024-03-25', 'present'),
(30, 4, 1, '2024-03-26', 'present'),
(31, 3, 1, '2024-03-24', 'present'),
(32, 3, 1, '2024-03-25', 'present'),
(33, 3, 1, '2024-03-26', 'absent'),
(34, 4, 1, '2024-03-24', 'present'),
(35, 4, 1, '2024-03-25', 'present'),
(36, 4, 1, '2024-03-26', 'present'),
(37, 3, 1, '2024-03-24', 'present'),
(38, 3, 1, '2024-03-25', 'present'),
(39, 3, 1, '2024-03-26', 'absent'),
(40, 4, 1, '2024-03-24', 'present'),
(41, 4, 1, '2024-03-25', 'present'),
(42, 4, 1, '2024-03-26', 'present'),
(43, 3, 1, '2024-03-24', 'present'),
(44, 3, 1, '2024-03-25', 'present'),
(45, 3, 1, '2024-03-26', 'absent'),
(46, 4, 1, '2024-03-24', 'present'),
(47, 4, 1, '2024-03-25', 'present'),
(48, 4, 1, '2024-03-26', 'present');
...
(86, '1', '::1', 'success', '2024-11-06 14:33:27');
...
(1, 'christian', 'pacifico', 'ilagan', 'BSIT-4A', '2', 2, 'king', 'king@student.camerino.edu.ph', 'king123', '../images/student1.png', 0, NULL, 'active', 0, '2024-11-04 15:46:02'),
(2, 'Christopher', 'Pacifico', 'Ilagan', 'BSIT-4A', '', 2, 'tupey', 'tupey@student.camerino.edu.ph', '$2y$10$gnMGZCxQUXH7GsjIcpwnC.5ow3Bzr89W5TUKlOszylFRINkUgv7PC', 'Bacoor', 0, NULL, 'active', 0, NULL),
(3, 'Maria', 'Santos', 'Garcia', 'BSIT-4A', '', 2, 'maria', 'maria@student.camerino.edu.ph', 'maria123', '../images/student3.png', 0, NULL, 'active', 0, NULL),
(4, 'Juan', 'Cruz', 'Martinez', 'BSIT-4A', '', 2, 'juan', 'juan@student.camerino.edu.ph', 'juan123', '../images/student4.png', 0, NULL, 'active', 0, NULL),
(5, 'Ana', 'Reyes', 'Lopez', 'BSIT-4B', '', 2, 'ana', 'ana@student.camerino.edu.ph', 'ana123', '../images/student5.png', 0, NULL, 'active', 0, NULL);
...
(9, 3, 1, '2024-03-24 15:30:00', 88.00, NULL, NULL),
(10, 4, 1, '2024-03-24 16:45:00', 92.50, NULL, NULL),
(11, 5, 1, '2024-03-24 14:15:00', 95.00, NULL, NULL),
(12, 2, 1, '2024-03-24 14:30:00', 95.50, NULL, NULL),
(13, 2, 2, '2024-03-27 16:45:00', 88.75, NULL, NULL),
(14, 1, 1, '2024-03-25 09:15:00', 78.25, NULL, NULL);
...
(1, 'jk', 'jk', 'Jomar', 'Pabuaya', 'smith', 'College of Industrial Technology', 1, 'uploads/images (3).jpg', 0, NULL, 1, 1, 'active'),
(2, 'chaw', 'pan', 'Charito', 'Puray', 'dela tore', 'College of Industrial Technology', 2, 'uploads/images (3).jpg', 0, NULL, 1, 1, 'active');
...
--
ALTER TABLE `security_violations`
  ADD CONSTRAINT `security_violations_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`),
  ADD CONSTRAINT `security_violations_ibfk_2` FOREIGN KEY (`quiz_id`) REFERENCES `activities` (`activity_id`);
