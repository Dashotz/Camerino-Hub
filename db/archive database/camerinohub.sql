...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2024 at 04:52 PM
...
INSERT INTO `activities` (`activity_id`, `teacher_id`, `section_subject_id`, `title`, `description`, `file_path`, `type`, `points`, `quiz_link`, `quiz_duration`, `prevent_tab_switch`, `fullscreen_required`, `quiz_attempts`, `due_date`, `created_at`, `updated_at`, `status`) VALUES
(1, 1, 1, 'asd', 'asd', NULL, 'activity', 100, NULL, NULL, 0, 0, 1, '2024-11-14 10:16:00', '2024-11-07 09:16:32', '2024-11-07 09:42:20', 'inactive'),
(2, 1, 1, 'Documentation', 'qweqweqweqweqwe', NULL, 'activity', 100, NULL, NULL, 0, 0, 1, '2024-11-14 10:42:00', '2024-11-07 09:43:17', '2024-11-07 09:43:17', 'active'),
(3, 1, 1, 'quiz', 'test', NULL, 'quiz', 100, NULL, NULL, 0, 0, 1, '2024-11-14 12:13:00', '2024-11-07 11:17:02', '2024-11-07 11:17:02', 'active');
...
(1, 'admin', '96ac0342a3ccf9553e3d4c9da9b821b0', 'admin@camerinohub.edu.ph', 'System', 'Administrator', 'active', '2024-11-06 15:41:01');
...
(1, 'BSIT-4A', '7', 1, '', 'active', '2024-11-06 17:17:35');
...
(1, 'king', 'b38ce63f61c5be0f1a1906d4d37b8725', 'student1@camerinohub.edu.ph', 'christian', 'pacifico', NULL, NULL, 'BSIT-2A', 'active', 0, NULL, 1, '2024-11-06 15:41:01', '2024-11-07 15:16:31'),
...
INSERT INTO `subjects` (`id`, `subject_code`, `subject_title`, `subject_name`, `category`, `description`, `created_at`, `status`) VALUES
(1, 'ITEC', 'Code', 'Code', 'TLE', '1', '2024-11-06 18:11:35', 'active'),
(2, 'GNED-09', '', 'test', '', '1', '2024-11-06 18:16:53', 'active');
